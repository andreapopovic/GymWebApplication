...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEnd.Models.Trener", b =>
                {
                    ...
                    b.Property<int?>("TreneriTreningaID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TreneriTreningaID");

                    b.ToTable("Trener");
                });

            modelBuilder.Entity("BackEnd.Models.TreneriTreninga", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("NazivTreninga")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("NazivTrening");

                    b.HasKey("ID");

                    b.ToTable("TreneriTreninga");
                });
            ...
            modelBuilder.Entity("BackEnd.Models.Trening", b =>
                {
                    ...
                    b.Property<int?>("TreninziTreneraID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TreninziTreneraID");

                    b.ToTable("Trening");
                });

            modelBuilder.Entity("BackEnd.Models.TreninziTrenera", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("KorisnickoImeTrenera")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("KorisnickoImeTrenera");

                    b.HasKey("ID");

                    b.ToTable("TreninziTrenera");
                });
            ...
            modelBuilder.Entity("BackEnd.Models.Trener", b =>
                {
                    ...
                    b.HasOne("BackEnd.Models.TreneriTreninga", null)
                        .WithMany("TreneriZadatogTreninga")
                        .HasForeignKey("TreneriTreningaID");
            ...
            modelBuilder.Entity("BackEnd.Models.Trening", b =>
                {
                    ...
                    b.HasOne("BackEnd.Models.TreninziTrenera", null)
                        .WithMany("TreninziZadatogTrenera")
                        .HasForeignKey("TreninziTreneraID");
            ...
            modelBuilder.Entity("BackEnd.Models.TreneriTreninga", b =>
                {
                    b.Navigation("TreneriZadatogTreninga");
                });
            ...
            modelBuilder.Entity("BackEnd.Models.TreninziTrenera", b =>
                {
                    b.Navigation("TreninziZadatogTrenera");
                });
